...
def main():
    ...
    bbs = {'amine/2': iglob(join(db, 'amine2', '*')),
           ...
           'alkene/2': iglob(join(db, 'terminal_alkene2', '*')),
           ...
           'alkene/3': iglob(join(db, 'terminal_alkene3', '*')),
           ...
           'alkene/4': iglob(join(db, 'terminal_alkene4', '*')),
    ...
    reactions = {1: ('amine/2', 'aldehyde/3', [stk.FourPlusSix(), stk.EightPlusTwelve()]),
                 ...
                 3: ('alkene/2', 'alkene/3', [stk.FourPlusSix()]),
                 ...
                 11: ('amine/3', 'aldehyde/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),
                 12: ('amine2/3', 'carboxylic_acid/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),
                 13: ('alkene/3', 'alkene/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),
                 14: ('alkyne/3', 'alkyne/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),
                 15: ('alkyne2/3', 'alkyne2/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),
                 16: ('boronic_acid/3', 'diol/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),
                 17: ('thiol/3', 'thiol/3', [stk.FourPlusFour(bb_assignments=[0, 1, 1, 0, 1, 0, 0, 1])]),

                 18: ('amine/4', 'aldehyde/2', [stk.SixPlusTwelve()]),
                 19: ('aldehyde/4', 'amine/2', [stk.SixPlusTwelve()]),
                 20: ('alkene/4', 'alkene/2', [stk.SixPlusTwelve()]),
                 ...
                 28: ('alkene/4', 'alkene/3', [stk.SixPlusEight()]),
